...
public class GraphicOverlay extends View {
    ...
    public static abstract class Graphic {
         ...
         * **************************************************
         */
        public float scaleNewY(float vertical, float count) {
            return (vertical/count) * mOverlay.mHeightScaleFactor;
        }


        public float scaleNewX(float horizontal, float count) { return (horizontal/count) * mOverlay.mWidthScaleFactor;
        }
